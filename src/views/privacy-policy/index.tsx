...
import {apiGetPrivacyPolicyPageContent} from '../../store/privacy-policy';
...
export default function PrivacyPolicyPage(): JSX.Element {
    ...
    // Redux states
    const {contentful} = useSelector((state: any) => state.privacyPolicy);

    useEffect(() => {
        if (_.isEmpty(contentful)) {
            dispatch(apiGetPrivacyPolicyPageContent({config}));
        }
    }, [dispatch, contentful]);
